...
//Note: this is a "lazy" approach that doesn't take into account keeping a consistent flow of direction
//and thus generates potentially unnecessary misses.
...
//write to file
fs.writeFile("./../knitout-backend-swg/examples/in/short_rows_alternate.knitout", kCode, function(err) {
    if(err) {
